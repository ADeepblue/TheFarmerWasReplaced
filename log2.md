...
面积计算是(5+3+1)*2+7 = 25
如果再在一个横向界面允许放一个的话,也就是类似于以下结构,其实可以维持密排
   11
  1111
 111111
11111111
...
## 仙人掌排行榜
1. 先有list内部先排序,然后得出最优解后行动
2. 考虑全局录入变量然后统筹规划小的和大的路径
